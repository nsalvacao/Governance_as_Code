...
Use `artifacts/01_Governance_Method/templates/partials/source_attribution.md` as the canonical snippet. Append it to new artifacts at creation time and update the placeholder values. Automation agents may inject the snippet and leave the attribution block untouched while updating other sections.
