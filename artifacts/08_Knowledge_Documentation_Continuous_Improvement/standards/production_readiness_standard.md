...
- Downstream repos instantiate the canonical production readiness review template at `artifacts/04_Quality_Review_Control/templates/production_readiness_review.md`.
